...
class ListaTipodocModeloDocfisc(models.Model):
    ...
    tipodoc = models.IntegerField(db_column='TIPODOC')  # Field name made lowercase. The composite primary key (TIPODOC, MODELO_DOCFISC) found, that is not supported. The first column is selected.
